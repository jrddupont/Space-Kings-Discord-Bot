...
function desperado(skUser, message, argumentString){
  skUser.desperado = true;
  message.channel.send('You are now a desperado!')
}
function undesperado(skUser, message, argumentString){
  skUser.desperado = false;
...
function summarizeDeck(skUser, message, argumentString){
  ...
  var summaryString = "You have " + skUser.deck.length + " cards remaining in the deck, " + `${faceCards} face, ${jokers} joker, ${criticals} critical.`
